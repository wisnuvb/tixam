          ...
          <div class="tab-pane" id="tabSekolah">
            ...
            <table class="table table-striped">
              ...
              <tr>
                ...
                <td>
                  @if($user->status == 'A')
                    <span class="wrap-is" data-toggle="tooltip" title="Klik disini untuk merubah data.">{{ $sekolah->kab_kot }}</span>
  ...
  <div class="box box-danger">
    ...
    <div class="box-body">
      ...
      <p>
        ...
        <!-- File terbaru aplikasi ini bisa di temukan di akun Github <a href="https://github.com/wisnuvb/TiXam" target="_blank">Disini</a>. Sangat kami sarankan untuk menggunakan <a href="https://getcomposer.org" target="_blank">Composser</a> dan <a href="https://git-scm.com" target="_blank">GIT</a> untuk mengupdate Aplikasi ini. Jangan lupa kasih star (<i class="fa fa-star-o" aria-hidden="true"></i>) ya <i class="fa fa-smile-o" aria-hidden="true"></i> <i class="fa fa-smile-o" aria-hidden="true"></i> <i class="fa fa-smile-o" aria-hidden="true"></i>. -->
      </p>
      <p>
        Aplikasi ini dapat digunakan secara gratis dibawah lisensi dari Tipamedia. Dilarang keras memperjual belikan aplikasi ini tanpa seizin dari Tipamedia.
      </p>
      @endif
    </div>
  </div>
